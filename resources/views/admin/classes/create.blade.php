    ...
    <div class="card" style="max-width: 1050px; padding: 3rem;">
        ...
        <form action="{{ route('admin.classes.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div style="margin-bottom: 2rem;">
                ...
                <textarea name="description" rows="3" required style="width: 100%; background: #111; border: 1px solid var(--border); padding: 1.2rem; color: #fff;">{{ old('description') }}</textarea>
            </div>
            ...
            <div class="grid" style="grid-template-columns: 1fr 1fr; gap: 2rem; margin-top: 0; padding: 0;">
                <div style="margin-bottom: 2rem;">
                    ...
                    <input type="text" name="schedule" value="{{ old('schedule') }}" placeholder="e.g. Mon, Wed | 6PM" required style="width: 100%; background: #111; border: 1px solid var(--border); padding: 1.2rem; color: #fff;">
                </div>
                <div style="margin-bottom: 2rem;">
                    ...
                    <input type="text" name="instructor" value="{{ old('instructor') }}" required style="width: 100%; background: #111; border: 1px solid var(--border); padding: 1.2rem; color: #fff;">
                </div>
            </div>
            ...
            <div style="margin-top: 3rem;">
                <button type="submit" class="btn btn-dark" style="padding: 1rem 3rem;">SAVE CLASS</button>
