...
@section('content')
    <section>
        ...
        <div class="grid" style="margin-top: clamp(3rem, 10vh, 5rem);">
            <div class="card reveal">
                ...
                <h3>URBAN EVOLVE</h3>
                <p>Advanced choreography focused on texture, isolation, and elite musicality. Designed for the experienced
                    artist.</p>
                <p style="margin-top: auto; padding-top: 2rem; font-weight: 700; color: var(--fg); letter-spacing: 1px;">TUE
                    / THU - 07:00 PM</p>
            </div>
            <div class="card reveal" style="transition-delay: 0.1s;">
                ...
                <p style="margin-top: auto; padding-top: 2rem; font-weight: 700; color: var(--fg); letter-spacing: 1px;">MON
                    / WED / FRI - 05:00 PM</p>
            </div>
            <div class="card reveal" style="transition-delay: 0.2s;">
                ...
                <p style="margin-top: auto; padding-top: 2rem; font-weight: 700; color: var(--fg); letter-spacing: 1px;">
                    WEEKENDS - 10:00 AM</p>
            </div>
        </div>
    </section>
    ...
    <section class="reveal">
        ...
        <div style="display: flex; flex-wrap: wrap; gap: 1rem;">
            ...
            <div
                style="padding: 1rem 2rem; border: 1px solid var(--border); font-weight: 700; font-size: 0.9rem; letter-spacing: 1px; text-transform: uppercase;">
                Commercial Urban</div>
            <div
                style="padding: 1rem 2rem; border: 1px solid var(--border); font-weight: 700; font-size: 0.9rem; letter-spacing: 1px; text-transform: uppercase;">
                Freestyle Training</div>
        </div>
    </section>
    ...
    <section class="reveal" style="text-align: center;">
        ...
        <p
            ...
            mentored by finalists of DID Little Master & Hip Hop India.
        </p>
